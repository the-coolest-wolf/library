    ...
    <SafeAreaProvider>
        <SafeAreaView style={styles.container}>
            <ScrollView style={styles.awesomeScrollyView}>
                ...
                <SafeAreaView>
                    <Image style={styles.book} source={require('../../assets/nothing.png')} />
                ...
                <SafeAreaView>
                    <Image style={styles.authorStyle} source={require('../../assets/nothing.png')} />
...
const styles = StyleSheet.create({
    ...
    book: { height: 270, width: 270, marginTop: 40, marginLeft: 40, marginBottom: -65 },
    ...
    authorStyle: { height: 270, width: 270, marginLeft: 40, marginTop: 65, }
});